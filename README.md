...
FastAuth is a api to create a user with OAuth2 authentication for FastAPI. FastAuth is written in [Python](https://www.python.org/) using the [FastAPI](https://fastapi.tiangolo.com/) web framework. 

---

**Source Code**: <a href="https://github.com/mkeller3/FastAuth" target="_blank">https://github.com/mkeller3/FastAuth</a>

---

## Requirements

FastAuth requires PostGIS >= 2.4.0.
